  ...
  <el-form :model="addCoupon" :rules="addRules" ref="addCoupon" label-width="120px">
    <div class="basic">
      ...
      <el-form-item label="活动规则:" prop="rules">
        消费满<el-input v-model="addCoupon.rules.exchange_full"></el-input>元，可换购<el-input v-model="addCoupon.rules.exchange_count"></el-input>件
      </el-form-item>
    ...
    <select-goods :promotionType="type" :selectVisible="selectVisibleGift" :selectList="selectListGift" @visible-change="handleVisibleGift" @choose-submit="handleAddGift"></select-goods>
      ...
      handleSubmit(){
        this.$refs.addCoupon.validate((valid) => {
          if (valid) {
            ...
            exchange.createExchangeBuy(this.addCoupon).then((res)=>{
              if(res.code==0){
                this.$message({
                  showClose: true,
                  message: '创建成功',
