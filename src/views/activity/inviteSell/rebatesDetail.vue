<template>
    <div>
        <el-form>
            <el-row>
                ...
                <el-col :span='3' :offset="1">
                    <el-button type="primary" icon="el-icon-search" @click="getRebateDetailList(form)">搜索</el-button>
                </el-col>
        ...
        <el-table class="table" :data="list" border align="center"  id='rebateSetTable' :span-method="spanMethod">
            ...
            <el-table-column align="center" label="返点比率" prop="bonus_rate">
            </el-table-column>
            <el-table-column align="center" label="返点" prop="settled_income">
            </el-table-column>
        </el-table>
        <pagination-view 
...
export default {
    ...
    methods:{
        getRebateDetailList(data){
            inviteSell.getRebateDetailList(data).then((res)=>{
        ...
        sizeChange(val){
            ...
            this.getRebateDetailList(this.form)
       },
        pageChange(val){
            this.form.page =val;
            this.getRebateDetailList(this.form)
       ...
       exportExcel () {
            ...
            setTimeout(function(){
                ...
                try {
                    FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '返点订单明细.xlsx');
                    } catch (e)
                    {
