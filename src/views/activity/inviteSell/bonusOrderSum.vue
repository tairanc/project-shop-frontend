        ...
        <el-form>
            <el-row>
                ...
                <el-col :span='3' :offset="1">
                    <el-button type="primary" icon="el-icon-search" @click="getOrderSumList(form)">搜索</el-button>
                </el-col>
    ...
    data(){
        return{
            ...
            columns:[
                ...
                {label: '提成支出',field: 'sum_settled_income',align: 'center'},
                {label: '平均提成比率',field: 'avg_bonus_rate',align: 'center'},
                {label: '审核状态',field: 'check_status',align: 'center'},
            ]
        }
    },
    methods:{
        getOrderSumList(data){
            inviteSell.getOrderSumList(data).then((res)=>{
        ...
        sizeChange(val){
            ...
            this.getOrderSumList(this.form)
       },
        pageChange(val){
            this.form.page =val;
            this.getOrderSumList(this.form)
       ...
       exportExcel () {
            ...
            inviteSell.getOrderSumList(this.form).then((res)=>{
                this.total =res.data.total_count
                this.list =[]
                for(var i in res.data.data){
                    this.list.push(res.data.data[i])
                ...
                setTimeout(function(){
                    ...
                    try {
                        FileSaver.saveAs(new Blob([wbout], { type: 'application/octet-stream' }), '提成订单汇总.xlsx');
                        } catch (e)
                        {
