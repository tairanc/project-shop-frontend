<template>
  <el-form :model="addCoupon" :rules="addRules" ref="addCoupon" label-width="120px">
    ...
    <div class="goods">
      ...
      <el-row class="pl20">
        ...
        <el-table class="table" :data="goodsList" border align="center" :span-method="spanMethod" >
          ...
          <el-table-column align="center" label="总库存" prop="store">
          </el-table-column>
    ...
    <el-row type="flex" justify="center">
      <el-button type="primary" @click="handleSubmit" :disabled="canclick">提交</el-button>
      ...
      handleSubmit(){
        ...
        this.$refs.addCoupon.validate((valid) => {
          if (valid) {
            ...
            seckill.createSeckill(this.addCoupon).then((res)=>{
              if(res.code==0){
                this.$message({
                  showClose: true,
                  message: '创建成功',
